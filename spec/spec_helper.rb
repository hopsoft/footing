...
#
# The traditional assert allows me to write the same style of code I would in the app itself.
# This feels much more natural to me. You might not agree, but I'm sticking to my old fashioned assert.
module GrumpyOldMan

  # A simple assert for RSpec so folks don't have to learn a complex
  ...
  def assert_raise(ex)
    expect yield.to raise_error(ex)
  end
